...
* THREE
*
* Feedback: In the given code, you create an object of the class Display in the ‘main’ method and when you create it,
* the constructor of the class Display is automatically invoked. Since no argument is passed, the constructor public
* Display() will be invoked with no arguments.
