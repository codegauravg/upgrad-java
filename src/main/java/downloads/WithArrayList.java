...
public class WithArrayList {
  ...
  public static void main (String[] args) {
    ...
    studentList.add(new StudentOne("Sujit", 1));
    studentList.add(new StudentOne("Siddharth", 2));
    studentList.add(new StudentOne("Karanpreet", 3));
...
class StudentOne {
  ...
  public StudentOne(String name, int rollNumber) {
    this.name = name;
